    ...
    describe("mvSync()", function () {
        ...
        describe("on a source file path with target file path", function () {
            ...
            it("should move a file", function () {
                ...
                var performMv = function () {
                    try {
                        return CoreUtil.mvSync({source: tempFile.path, destination: destinationPath})
                    } catch (err) {
                        console.error(err);
                        throw err;
        ...
        describe("on a source file path with target directory path", function () {
            ...
            it("should move a file", function () {
                ...
                var performMv = function () {
                    try {
                        return CoreUtil.mvSync({source: tempFile.path, destination: destinationDir.path})
                    } catch (err) {
                        console.error(err);
                        throw err;
        ...
        describe("on a source directory path with target path and recursive = true", function () {
            ...
            it("should move a file tree", function () {
                ...
                var performMv = function () {
                    try {
                        return CoreUtil.mvSync({source: fileTree.path, destination: destinationPath, recursive: true})
                    } catch (err) {
                        console.error(err);
                        throw err;
