    ...
    describe("mvSync()", function () {
        ...
        describe("on a source file path with target file path", function () {
            ...
            it("should move a file", function () {
                ...
                (function () {
                    try {
                        return CoreUtil.mvSync({source: tempFile, destination: tempFileDestination})
                    } catch (err) {
                        console.error(err);
                        throw err;
                    }
        ...
        describe("on a source file path with target directory path", function () {
            ...
            it("should move a file", function () {
                ...
                (function () {
                    try {
                        return CoreUtil.mvSync({source: tempFile, destination: tempFileDestinationDir})
                    } catch (err) {
                        console.error(err);
                        throw err;
                    }
                ...
                (function () {
                    try {
                        return CoreUtil.mvSync({
                            source: tempWorkDir,
                            destination: tempWorkDirDestination,
                            recursive: true
                        })
                    } catch (err) {
                        console.error(err);
