    ...
    describe("lnSync()", function () {
        ...
        describe("on a file path", function () {
            ...
            it("should create a hard link", function () {
                ...
                (function () {
                    try {
                        return CoreUtil.lnSync({source: tempFile.path, destination: templnFile})
                    } catch (err) {
                        console.error(err);
                        throw err;
                    }
            ...
            it("should create a symbolic link", function () {
                ...
                (function () {
                    try {
                        return CoreUtil.lnSync({source: tempFile.path, destination: tempSymlinkFile, symbolic: true})
                    } catch (err) {
                        console.error(err);
                        throw err;
                    }
