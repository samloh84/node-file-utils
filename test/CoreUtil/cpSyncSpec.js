    ...
    describe("cpSync()", function () {
        ...
        describe("on a source file path with target file path", function () {
            ...
            it("should copy a file", function () {
                ...
                (function () {
                    try {
                        return CoreUtil.cpSync({source: tempFile, destination: tempFileDestination})
                    } catch (err) {
                        console.error(err);
                        throw err;
                    }
        ...
        describe("on a source file path with target directory path", function () {
            ...
            it("should copy a file", function () {
                ...
                (function () {
                    try {
                        return CoreUtil.cpSync({source: tempFile, destination: tempFileDestinationDir})
                    } catch (err) {
                        console.error(err);
                        throw err;
                    }
