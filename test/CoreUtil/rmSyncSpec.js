    ...
    describe("rmSync()", function () {
        ...
        describe("on a source file path with target file path", function () {
            ...
            it("should delete a file", function () {
                ...
                (function () {
                    try {
                        return CoreUtil.rmSync({path: tempFile})
                    }
                    catch (err) {
                        console.error(err);
                        throw err;
        ...
        describe("on a source directory path with target directory path and recursive = true", function () {
            ...
            it("should remove a file tree", function () {
                ...
                (function () {
                    try {
                        return CoreUtil.rmSync({path: tempWorkDir, recursive: true});
                    }
                    catch (err) {
                        console.error(err);
                        throw err;
                ...
                for (var i = 0; i < tempFiles.length; i++) {
                    (function () {
                        return fs.accessSync(tempFiles[i])
                    })
                        .should.throw();
