...
describe("FileUtil", function () {
    ...
    describe("truncateSync()", function () {
        ...
        beforeEach(function () {
            ...
            FileTestUtil.writeFileSync(tempFile, tempFileContents, {
                mode: FileUtil.constants.S_IRWXU | FileUtil.constants.S_IRWXG,
                encoding: 'utf8'
            });
        ...
        it("should truncate the supplied file descriptor", function () {
            ...
            (function () {
                try {
                    return FileUtil.truncateSync({
                        path: tempFile,
                        len: Buffer.from(tempFileContents.slice(0, 16), 'utf8').byteLength
                    })
                } catch (err) {
                    console.error(err);
                    throw err;
            ...
            text.should.be.equal(tempFileContents.slice(0, 16));
